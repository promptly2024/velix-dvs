...
const prisma = new PrismaClient(); function ing(key: string, name: string, sources: DetectionSource[], scam: string) {
    ...
    console.log("Seeding FULL 13 Threat Categories + Ingredients..."); const threats = [
        {
            ...
            ingredients: [
                ...
                ing("demat_account_number", "Demat Account Number", ["WEB_SEARCH"], "Trading fraud"), ing("crypto_wallet_address", "Cryptocurrency Wallet Address", ["WEB_SEARCH", "DARK_WEB"], "Crypto theft"),
            ...
            ingredients: [
                ...
                ing("insurance_health_id", "Insurance Health ID", ["WEB_SEARCH"], "Policy fraud"), ing("vaccination_certificate", "Vaccination Certificate", ["WEB_SEARCH"], "Certificate misuse"),
            ...
            ingredients: [ing("app_signup_data", "App Signup Data", ["WEB_SEARCH"], "Profiling"),
            ...
            ingredients: [
                ...
                ing("web_mentions", "Web Mentions", ["WEB_SEARCH", "AI_PROMPT"], "Public exposure"),
                ing("password_leak", "Password Leak", ["BREACH"], "Password compromised"),
                ing("github_profile", "GitHub Profile", ["WEB_SEARCH"], "Developer identity exposure")
            ]
        }, {
            ...
            ingredients: [
                ...
                ing("tax_returns", "Tax Returns", ["WEB_SEARCH"], "Tax fraud exploitation"), ing("driving_penalty_records", "Driving Penalty Records", ["WEB_SEARCH"], "RTO-related fraud")
            ]
        }, {
